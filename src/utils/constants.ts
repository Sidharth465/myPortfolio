      ...
      projects: [
        {
          ...
          description:
            "Designed and developed an enterprise application for complaint resolution, staff and machine management, and product quality inspection. (Credit: Developed as part of my role at Richaco Exports)",
        },
        {
          name: "Gims Inventory App",
          description:
            "Developed an inventory management app to streamline asset tracking and improve operational efficiency. (Credit: Developed as part of my role at Richaco Exports)",
        },
      ],
    },
    {
      ...
      projects: [
        {
          ...
          description:
            "Developed a mental health consultation app utilizing Agora for seamless video-calling and OAuth for secure authentication, allowing users to book and conduct private video consultations. (Credit: Developed as part of my role at Ryt Click)",
        },
      ],
    },
    {
