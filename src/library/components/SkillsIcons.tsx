import { AndroidStudio, CssIcon, ExpressIcon, Git, HtmlIcon, JsIcon, NodejsIcon, PostgreIcon, ReactIcon, ReduxIcon, TailwindCssIcon, Typescript, Xcode } from "@assets/index"
...
const SkillsIcons = () => {
  return (
    <div className="flex flex-row flex-wrap justify-center gap-3 md:gap-5   mt-5 items-center">
      ...
      <img className=" h-[35px]  object-contain " src={TailwindCssIcon} />
